...
(function () {
  ...
  // The redesign runs the coach on real phone surfaces too (Browse → Part →
  // Article → session → Calendar → Settings → Today). Persistence is still
  // onboarding_status; the tour never marks modes Done.
