...
def test_settings_assets_and_hooks(tmp_path: Path):
    ...
    assert "styles.css?v=main61" in html
    assert "mobile.css?v=mob89" in html
    assert "app.js?v=main61" in html
    css = client.get("/static/mobile.css?v=mob89").text
    ...
    styles = client.get("/static/styles.css?v=main61").text
    assert "--bare-size" in styles
    assert "var(--bare-size" in styles
    js = client.get("/static/app.js?v=main61").text
