...
def test_settings_assets_and_hooks(tmp_path: Path):
    ...
    assert "styles.css?v=main57" in html
    assert "mobile.css?v=mob82" in html
    assert "app.js?v=main57" in html
    css = client.get("/static/mobile.css?v=mob82").text
    ...
    styles = client.get("/static/styles.css?v=main57").text
    assert "--bare-size" in styles
    assert "var(--bare-size" in styles
    js = client.get("/static/app.js?v=main57").text
