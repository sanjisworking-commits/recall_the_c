...
This implementation branches from `cursor/playground-220d` at
`233d624462ec99a793099575edfb9a13a3a36f41`. The feature branch is
`codex/playground-study-calendar`.

To try it from your local repository:

```sh
git fetch origin
git switch --track origin/codex/playground-study-calendar
```

Then restart your normal port-8001 launcher. If you already have this branch
locally, use `git switch codex/playground-study-calendar` instead.
