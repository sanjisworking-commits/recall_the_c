...
| Playground overlay | [`20260906_0017_playground_overlay.py`](../alembic/versions/20260906_0017_playground_overlay.py) | `user_playground_item` / `selection` / `progress` — **persistent learning only** (`overlay != roster`). Proof revision rows remain for M8. |
| Playground mode progress | [`20260924_0025_playground_mode_progress.py`](../alembic/versions/20260924_0025_playground_mode_progress.py) | `user_playground_mode_progress` — independent Read/Cloze/Letters/Type/Recite/Test completion. Type is write-it-out. No seventh Write mode. Does not start Day 1. |
